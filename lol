local espLibrary = {
  ...
  -- Define macros for creating drawing objects and setting properties
  ...
  local function setDrawingProperties(drawing, properties)
    for i, v in next, properties do
        drawing[i] = v
    end
  end
  ...
  function espLibrary.addEsp(player)
    ...
    local objects = {
        arrow = createDrawing("Triangle", { Thickness = 1 }),
        arrowOutline = createDrawing("Triangle", { Thickness = 1 }),
        bottom = createDrawing("Text", { Center = true, Size = 13, Outline = true, OutlineColor = color3New(), Font = 2 }),
        tool = createDrawing("Text", { Center = true, Size = 13, Outline = true, OutlineColor = color3New(), Font = 2 }),
        top = createDrawing("Text", { Center = true, Size = 13, Outline = true, OutlineColor = color3New(), Font = 2 }),
        side = createDrawing("Text", { Size = 13, Outline = true, OutlineColor = color3New(), Font = 2 }),
        boxFill = createDrawing("Square", { Thickness = 1, Filled = true }),
        boxOutline = createDrawing("Square", { Thickness = 3, Color = color3New() }),
        box = createDrawing("Square", { Thickness = 1 }),
        healthBarOutline = createDrawing("Square", { Thickness = 1, Color = color3New(), Filled = true }),
        healthBar = createDrawing("Square", { Thickness = 1, Filled = true }),
        lineoutline = createDrawing("Line", { Thickness = 3 }),
  ...
  function espLibrary.addChams(player)
    ...
    espLibrary.chamsCache[player] = createDrawing("Highlight", {
        Parent = screenGui,
    });
  end
