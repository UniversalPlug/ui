...
Bracket.Utilities = {
	...
	MakeResizeable = function(Dragger, Object, MinSize, MaxSize, OnChange, OnEnd)
		...
		Dragger.InputBegan:Connect(function(Input)
			if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
				Position = Input.UserInputType == Enum.UserInputType.Touch and UserInputService:GetTouchLocation(1) or UserInputService:GetMouseLocation() -- Use GetTouchLocation for touch
		...
		UserInputService.InputChanged:Connect(function(Input)
			if StartSize and (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) then
				local Mouse = Input.UserInputType == Enum.UserInputType.Touch and UserInputService:GetTouchLocation(1) or UserInputService:GetMouseLocation() -- Use GetTouchLocation for touch
				local Delta = Mouse - Position
