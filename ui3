...
Bracket.Assets = {
	...
	Window = function()
		...
		Label.Text = "URL: discord.x-ro.cc"
	...
	Colorpicker = function()
		...
		Colorpicker.TextColor3 = Color3.fromRGB(255, 0, 0)
		Colorpicker.Text = ""
	...
	ColorpickerPalette = function()
		...
		Palette.Size = UDim2.new(0, 150, 0, 310)
		Palette.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Palette.Position = UDim2.new(0, 100, 0, 100)
		Palette.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
		...
		Outline.LayoutOrder = 6
		Outline.AnchorPoint = Vector2.new(0.5, 0)
		Outline.Size = UDim2.new(1, 0, 0, 14)
		Outline.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Outline.BackgroundTransparency = 1
		Outline.Position = UDim2.new(0.5, 0, 0, 290)
		...
		Outline.Text = ""
		Outline.FontFace = Font.fromEnum(Enum.Font.SourceSans)
		Outline.Parent = Palette

		local OutlineTick = Instance.new("Frame")
		OutlineTick.Name = "Tick" 
		OutlineTick.Size = UDim2.new(0, 10, 0, 10)
		OutlineTick.BorderColor3 = Color3.fromRGB(0, 0, 0)
		OutlineTick.Position = UDim2.new(0, 0, 0, 2)
		OutlineTick.BackgroundColor3 = Color3.fromRGB(63, 63, 63)
		OutlineTick.Parent = Outline

		local OutlineGradient = Instance.new("UIGradient")
		OutlineGradient.Name = "Gradient"
		OutlineGradient.Rotation = 90
		OutlineGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(191, 191, 191))
		OutlineGradient.Parent = OutlineTick

		local OutlineTitle = Instance.new("TextLabel")
		OutlineTitle.Name = "Title"
		OutlineTitle.Size = UDim2.new(1, -14, 1, 0)
		OutlineTitle.BorderColor3 = Color3.fromRGB(0, 0, 0)
		OutlineTitle.BackgroundTransparency = 1
		OutlineTitle.Position = UDim2.new(0, 14, 0, 0)
		OutlineTitle.BorderSizePixel = 0
		OutlineTitle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		OutlineTitle.TextStrokeTransparency = 0.75
		OutlineTitle.TextSize = 14
		OutlineTitle.TextColor3 = Color3.fromRGB(252, 252, 252)
		OutlineTitle.Text = "Outline"
		OutlineTitle.FontFace = Font.fromEnum(Enum.Font.SourceSans)
		OutlineTitle.TextXAlignment = Enum.TextXAlignment.Left
		OutlineTitle.Parent = Outline
...
Bracket.Elements = {
	Screen = function()
		...
		ScreenAsset.Name = "Stop looking at this.."
	...
	Window = function(Window)
		...
		function Window.LoadConfig(Self, FolderName, Name)
			if table.find(Bracket.Utilities.GetConfigs(FolderName), Name) then
				local filePath = FolderName .. "\\Configs\\" .. Name:gsub("^X%-", "") .. ".json"   
				local filePath2 = FolderName .. "/Configs/" .. Name:gsub("^X%-", "") .. ".json"

				if isfile(filePath) or isfile(filePath2) then  
